...
var lines=headline.querySelectorAll(".hli");
gsap.set([logoDiv,sub,legal].filter(Boolean),{opacity:0});
gsap.set(lines,{yPercent:110});
gsap.set(ctaC,{width:0});
var tl=gsap.timeline({delay:.25});
tl.to(intro,{duration:.8,y:600,ease:e},0)
.from(photo,{duration:7,scale:1.28,transformOrigin:"50% 40%",ease:"power1.out"},0)
.from(photoC,{duration:.8,y:-156,ease:e},0)
.from(bg,{duration:.8,y:-120,ease:e},0)
.from(logoUSB,{duration:.7,y:34,opacity:0,ease:e},.45)
.from(logoNFL,{duration:.7,y:-34,opacity:0,ease:e},.45)
.to(logoDiv,{duration:.5,opacity:1,ease:"power1.inOut"},.6)
.to(lines,{duration:.7,yPercent:0,ease:e,stagger:.1},.5)
.to(sub,{duration:.6,opacity:1,ease:"power1.inOut"},.9)
.to(ctaC,{duration:.7,width:120,ease:e},1.1)
...
function staticFallback(){preload.style.display="none";intro.style.display="none";var l=headline.querySelectorAll(".hli");for(var i=0;i<l.length;i++)l[i].style.transform="none";}
